...
<div class="right_col noheigthwidt" role="main" >
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
     ...
     <!--       <a href="<?php echo base_url() ?>inventarios/addView"> <button type="button" class="btn btn-success">Agregar  Inventario</button></a> -->
    ...
    <script>
        $(document).ready(function() {
          ...
          var table = $('#datatable-responsive').DataTable({
                ...
                scrollX: true,
                ordering: false,
                ajax: "<?php echo base_url('Inventarios/dataListJson') ?>",
                dom: "Bfrtip",
                buttons: [
               ...
               /* columnDefs: [ {
                            ...
                            "render": function ( data, type, full, meta ) {
                              return '<a href="<?php echo base_url('invetarios/editView/') ?>'+data+'">Cambiar</a>';
                                 }
                          } ],*/
                ...
                columnDefs: [ {
                            ...
                            "data": "id",
                            "render": function ( data, type, full, meta ) {
                              return '<a href="<?php echo base_url('inventarios/editView/') ?>'+data+'">Ver</a>';
                                 }
                          } ]
