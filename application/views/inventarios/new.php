                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left" novalidate action="<?php echo base_url() ?>inventarios/UpdateInv" method="post" accept-charset="utf-8">

                       <!--         <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nombre Vendedor
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <select name="id_ven" id="id_ven" class="form-control" >
                                          
                                          <?php foreach ($VendedoresList as $key): ?>
                                              <option  value="<?php echo $key->id_ven ?>"><?php echo $key->nombre_ven ?></option>
