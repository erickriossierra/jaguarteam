                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left" novalidate action="<?php echo base_url() ?>estatus/UpdatePedidoEst/<?php echo html_escape($GetIdPedido[0]->id_ped) ?>" method="post" accept-charset="utf-8">
                                  ...
                                  <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                      <a href="<?php echo base_url('estatus') ?>"><button type="button" class="btn btn-primary">Cancelar</button></a>
