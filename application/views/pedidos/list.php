    ...
    <script>
        $(document).ready(function() {
          ...
          var table = $('#datatable-responsive').DataTable({
                ...
                scrollX: true,
                ordering: false,
                ajax: "<?php echo base_url('pedidos/dataListJson') ?>",
                dom: "Bfrtip",
                buttons: [
               ...
               /* columnDefs: [ {
                            ...
                            "render": function ( data, type, full, meta ) {
                              return '<a href="<?php echo base_url('pedidos/editViewEst/') ?>'+data+'">Cambiar</a>';
                                 }
                          } ],*/
                ...
                columnDefs: [ {
                            ...
                            "data": "id",
                            "render": function ( data, type, full, meta ) {
                              return '<a href="<?php echo base_url('pedidos/editView/') ?>'+data+'">Ver</a>';
                                 }
                          } ]
