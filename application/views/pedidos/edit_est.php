                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left" novalidate action="<?php echo base_url() ?>pedidos/UpdatePedidoEst/<?php echo html_escape($GetIdPedido[0]->id_ped) ?>" method="post" accept-charset="utf-8">
