                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left" novalidate action="<?php echo base_url() ?>despacho/dataUpdate/<?php echo html_escape($GetIdDespachos[0]->id) ?>" method="post" accept-charset="utf-8">
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Colonia</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="name" class="form-control col-md-7 col-xs-12" name="nombre" type="text" value="<?php echo html_escape($GetIdDespachos[0]->nombre) ?>">
                                        </div>
                                    </div>
