    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
            ...
            <a href="<?php echo base_url() ?>vendedores/addView"> <button type="button" class="btn btn-success">Agregar Vendedor</button></a>
    ...
    <script>
        $(document).ready(function() {
          ...
          var table = $('#datatable-responsive').DataTable({
                ...
                scrollX: true,
                ordering: false,
                ajax: "<?php echo base_url('vendedores/dataListJson') ?>",
                dom: "Bfrtip",
                buttons: [
...
*/
                ...
                columnDefs: [ {
                            ...
                            "render": function ( data, type, full, meta ) {
                              return '<a href="<?php echo base_url('vendedores/editView/') ?>'+data+'">Ver</a>';
                                 }
                          } ]
